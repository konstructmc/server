...
public class ModernCombatModule extends Module {
    public final CombatFeatureSet modernCombat = CombatFeatures.modernVanilla();

    @Override
    public void initialize(CustomInstance parent) {
        parent.eventNode().addChild(modernCombat.createNode());
    }
}
